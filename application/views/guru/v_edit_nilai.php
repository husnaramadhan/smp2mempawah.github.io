          ...
          <div class="col-lg">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">Form Edit Nilai </h1>
              </div>
              <form class="user" action="<?= base_url('guru/lihat_nilai/proses_edit') ?>" method="POST">
                ...
                <div class="form-group row">
                 ...
                 <input type="text" class="form-control form-control-user" id="exampleFirstName" disabled="" value="<?= $nilai->jenis ?>">
                </div>
                
                 <div class="form-group row">
                 <div>  
                 <label class="m-0 font-weight-bold text-primary"> Nilai</label ></div>
                 <input type="text" class="form-control form-control-user" id="exampleFirstName" placeholder="..." name="nilai" value="<?= $nilai->nilai ?>">
                 </div>
